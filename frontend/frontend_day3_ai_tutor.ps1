...
'@
$files['lib\services\subject_service.dart'] = @'
import '../core/constants/api_constants.dart';
...
/// state. All persistence goes through the backend's /api/ai/* endpoints —
...
'@
$files['lib\models\conversation.dart'] = @'
...
'@
$files['lib\models\recommendation.dart'] = @'
/// A "what to learn next" suggestion — mirrors the backend's
...
'@
$files['lib\widgets\recommendation_card.dart'] = @'
import 'package:flutter/material.dart';
import '../core/theme/app_colors.dart';
import '../core/theme/app_theme.dart';
import '../models/recommendation.dart';
...
'@
$files['lib\widgets\voice_button.dart'] = @'
import 'package:flutter/material.dart';
import 'package:speech_to_text/speech_to_text.dart' as stt;
import '../core/theme/app_colors.dart';

/// Basic speech-to-text mic button: tap to start listening, tap again (or
/// pause) to stop. Converts speech to text and hands it to [onResult] —
...
/// available, the button disables itself instead of crashing — this
...
'@
$files['lib\screens\ai\ai_tutor_screen.dart'] = @'
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import '../../core/theme/app_colors.dart';
import '../../core/theme/app_theme.dart';

/// AI Tutor home: 4 entry points — Ask Question (subject-scoped chat),
...
'@
$files['lib\screens\ai\recommendation_screen.dart'] = @'
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:provider/provider.dart';
import '../../core/theme/app_colors.dart';
...
/// "What to learn next" — rule-based recommendations computed from the
...
'@
$files['lib\screens\ai\homework_screen.dart'] = @'
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../core/theme/app_colors.dart';
import '../../core/theme/app_theme.dart';
...
/// examples, and tips — from the same rule-based engine as chat, plus a
...
Write-Host "Frontend AI Tutor (Day 3) files applied."
